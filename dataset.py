"""
dataset.py - stores the dataset classes
split: 'train' (80%), 'val' (10%), or 'test' (10%)
"""

from utils import os, random, kagglehub, Dataset, Image, T, TF
...
class RealBlurDataset:
    def __init__(self, split="train", image_size=256, augment=True):
        ...
        # download/Locate Dataset
        path = kagglehub.dataset_download("darthvader4067/realblur")
        base_path = os.path.join(path, "hideblur")
...
class DVDDataset:
    def __init__(self, split="train", image_size=256, augment=True):
        ...
        # download/Locate Dataset
        path = kagglehub.dataset_download("darthvader4067/deepvideodeblurring")

        # TODO


###
class TextDeblurringDataset:
    def __init__(self, split="train", image_size=256, augment=True):
        super().__init__()
