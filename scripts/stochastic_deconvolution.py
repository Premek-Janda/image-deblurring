...
def stochastic_deconvolution(blurred_img=None, blur_kernel_size=BLUR_KERNEL_SIZE, verbose=True, input_img=None):
    """Wrapper for the Numba-accelerated stochastic deconvolution core."""
    # Create output directory if it doesn't exist
    os.makedirs(SAVE_DIR, exist_ok=True)
    
    if input_img is None:
        raise ValueError("input_img must be provided")
